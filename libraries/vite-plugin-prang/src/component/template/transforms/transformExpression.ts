/**
 * Source: https://github.com/vuejs/core/blob/119f18c773b8d437fada3e0b8b847a282182c8dd/packages/compiler-core/src/transforms/transformExpression.ts#L117
 *
 * Modifications made for BindingTypes.SETUP_SIGNAL
 */
...
import type { NodeTransform, TransformContext } from '@vue/compiler-core';
import {
    BindingTypes,
...
export const transformExpression: NodeTransform = (node, context) => {
    if (node.type === NodeTypes.INTERPOLATION) {
        node.content = processExpression(node.content as SimpleExpressionNode, context);
    ...
    const rewriteIdentifier = (raw: string, parent?: Node | null, id?: Identifier) => {
        ...
        if (inline) {
            ...
            if (
                ...
                type === BindingTypes.SETUP_SIGNAL
            ) {
